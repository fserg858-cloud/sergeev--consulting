      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            ...
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-headline font-black text-white mb-8 leading-tight">
              Считаем окупаемость <br /><span className="text-accent italic">до того, как вы заплатите</span>
            </h3>
            
            <div className="premium-glass p-6 sm:p-8 rounded-3xl border border-accent/20 mb-10">
          ...
          <div className="space-y-8 mt-12 lg:mt-0">
            <div className="premium-glass p-8 sm:p-10 rounded-[2rem] sm:rounded-[3rem] border border-white/5 relative shadow-2xl">
              <div className="absolute -top-6 -right-2 sm:-right-6 h-16 w-16 sm:h-20 sm:w-20 rounded-full bg-accent flex items-center justify-center text-accent-foreground shadow-xl">
